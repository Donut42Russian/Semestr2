...
int main()
{
    ...
    while (m)
    {
        ...
        {
            system("cls");
            cout << "Enter flower characteristics:";
            cout << endl << "Name = "; cin >> A.name;
            cout << endl << "Weight = "; cin >> A.weight;
            cout << endl << "Age = "; cin >> A.age;
            cout << endl << "Thirst?(True or False) "; cin >> A.thirst;
            GetSeria(data, n, A);
            Q.Push(data, n);
            system("cls");
            break;
        ...
        case 2:
        {
            ...
            cout << "Thitst?(True or False) = "; cin >> A_x.thirst;
            int Y = Q.Count;
            for (int i = 0; i < Y; i++)
            {
                Q.Pop(data, n);
        ...
        case 3:
        {
            while (Q.Count)
            {
                ...
                cout << "Age = " << A.age << endl;
                cout << "Thirst?" << A.thirst << endl << endl;;
            }
            system("pause");
            system("cls");
            break;
